...
import { Dialog, DialogContent, CircularProgress, Grid, InputAdornment, TextField, Tooltip } from '@material-ui/core';
                ...
                if(json.product.images !== null){
                    ...
                    //! need to transform the weird base64 code to an img html object
                        for (const key in json) {
                            ...
                            tempImages.push(
                            <img className="img" src={'data:image/jpeg;base64,' + base64} alt={`webscraper ${key}`}/>
                            );
                        }
                        fetch(screenshot)
                        .then((res) => res.json())
                ...
                <DialogContent style={{ paddingTop: 25, paddingBottom: 25 }}>
                    <Grid spacing={2} wrap="nowrap" container>
                        ...
                        <Grid direction="column" container item>
                            <Grid item>
                                <h1 style={{ fontWeight: 'bold' }}>Get Feedback!</h1>
                            </Grid>
                            <Grid item>
                                <TextField
                                    variant="outlined"
