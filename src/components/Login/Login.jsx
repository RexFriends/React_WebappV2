        ...
        <>
            <div id="login" style={{ height: signUp ? '475px' : '320px' }}>
                ...
                <div id="option">
                    ...
                    <a
                        href={'https://chrome.google.com/webstore/detail/rex-social-shopping-assis/hhegepmkgedompkfdccmmajmknnnlele/related?hl=en&authuser=0'}
                        target="blank"
                        rel="noreferrer"
                    >
                        Download Extension
                ...
                </div>
                {
                    !signUp ?
                        <div id="content_1">
                            ...
                            <div id="trouble">
                                <a href="https://www.rexfriends.com/">Trouble logging in?</a>
                            </div>
                            <Button variant="contained" color="primary" onClick={handleLogin} size="small" id="login-button">
                                Log In
                            </Button>
                            <div id="seperator">
                                <div id="dash" />
                        ...
                        <div id="content_2">
                            ...
                            <div id="terms">
                                By clicking Sign Up, you are indicating that you have read and acknowledge the <a
                                href="https://www.rexfriends.com/">Terms of Service</a> and <a
                                href="https://www.rexfriends.com/">Privacy Notice</a>.
                            </div>
                            <Button variant="contained" color="primary" onClick={handleSignUp} size="small" id="signup-button">
                                Sign Up
                            </Button>
                            <div id="seperator">
                                <div id="dash" />
