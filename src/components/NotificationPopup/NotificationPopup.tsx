...
function NotificationPopup({
  ...
  const updateAllUnseenNotifications = (notifs: Array<INotification>) => {
    // update unseen notifs which aren't of the "requested feedback" type
    if (notifs) {
      const toUpdate: Array<NotificationUpdate> = notifs
    ...
    fetch(`${APIURL}/api/get_notif?uid=${rexUID}`)
      ...
      .then((json) => {
        ...
        if (update)
          setTimeout(
            () =>
              updateAllUnseenNotifications(json.notifications.notifications),
            2000
          );
      });
  };
  ...
  return (
    ...
    >
      {page === "notifications" ? (
        ...
        <div
          id="container"
          style={{ width: "100%", height: "100%", border: "solid red 2px" }}
        ></div>
      ) : page === "request" ? (
        <div
          id="container"
        ...
        >
          ...
          >
            ...
            <span style={{ margin: "auto auto auto 100px", fontWeight: 700 }}>
              Send Feedback
            </span>
          </div>
          {currentRequest ? (
            ...
            >
              <img
                src={currentRequest.profile_image}
                style={{
                  width: "45px",
                  height: "45px",
